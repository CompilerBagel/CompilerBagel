...
mainEntry1:
  ...
  store i32 10, i32* %count14, align 4
  br label %condBlock2
condBlock2:
  %count16 = load i32, i32* %count14, align 4
  %icmp_NE17 = icmp ne i32 %count16, 0
...
bodyBlock3:
  ...
  %arr21 = getelementptr [100 x i32], [100 x i32]* %arr11, i32 0, i32 %count20
  %count22 = load i32, i32* %count14, align 4
  store i32 %count22, i32* %arr21, align 4
  %count24 = load i32, i32* %count14, align 4
  %sub_25 = sub i32 %count24, 1
  store i32 %sub_25, i32* %count14, align 4
  br label %condBlock2
afterBlock4:
  br label %condBlock5
condBlock5:
  %count27 = load i32, i32* %count14, align 4
  %icmp_NE28 = icmp ne i32 %count27, 10
...
bodyBlock6:
  ...
  %add_32 = add i32 %count31, 1
  store i32 %add_32, i32* %count14, align 4
  %sum34 = load i32, i32* %sum12, align 4
  %count35 = load i32, i32* %count14, align 4
  %arr36 = getelementptr [100 x i32], [100 x i32]* %arr11, i32 0, i32 %count35
